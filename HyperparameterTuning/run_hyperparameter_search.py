...
from Recommenders.GraphBased.GraphFilterCFRecommender import GraphFilterCFRecommender
...
def runHyperparameterSearch_Collaborative(recommender_class, URM_train, URM_train_last_test = None,
    ...
    try:
       ...
       ##########################################################################################################
        ...
        if recommender_class is MatrixFactorization_WARP_Cython:
        ...
        if recommender_class is NegHOSLIMRecommender:
        ...
        if recommender_class is NegHOSLIMElasticNetRecommender:
        ...
        if recommender_class is NegHOSLIMLSQR:
       ...
       ##########################################################################################################
        ...
        if recommender_class is GraphFilterCFRecommender:
